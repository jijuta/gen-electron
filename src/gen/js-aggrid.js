...
const setctrl = function (payload, self) {
    ...
    agGrid.LicenseManager.setLicenseKey("CompanyName=saesolsoft,LicensedApplication=wooriProof,LicenseType=SingleApplication,LicensedConcurrentDeveloperCount=1,LicensedProductionInstancesCount=1,AssetReference=AG-024188,ExpiryDate=5_January_2023_[v2]_MTY3Mjg3NjgwMDAwMA==fefe7da4e23a7f0ce09a3e08f30569c5");
    
    // ag-grid options settings 초기 버전
    const gridOptions = {
		rowData: null,  
        columnDefs: [
            ${payload.dataTypeAGgridDataHtml}
        ]
    };
               ...
               // var clCodeInfo = this.searchVo.clCodeInfo; // 
                ...
                axios({
                    ...
                    Vue.nextTick(function () {
                        ...
                        gridOptions.api.setRowData(response.data.resultList);
