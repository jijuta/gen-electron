...
const setctrl = function(payload, utils)  {
  ...
  let tb = payload.selectedSearchobj[0];
  let SampleVoPrivate = "";
  let SampleVoPublic = "";
  for (var item in payload.selectedSearchobj) {
    let row = payload.selectedSearchobj[item];
...
@Data
@NoArgsConstructor
public class Search${payload.Sample}Request{
${vHtml}
    /** 통합검색 */
